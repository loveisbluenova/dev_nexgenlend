...
@section('top')
    <header class="page-header wpex-supports-mods">
        <div class="page-header-inner container clr">
            <h1 class="page-header-title wpex-clr" itemprop="headline"><span>Consolidate Your Debt</span></h1>
            <nav class="site-breadcrumbs wpex-clr hidden-phone position-absolute has-js-fix"><span class="breadcrumb-trail"><span><span><a href="/">Home</a> &raquo; <span><a href="/refinance">Refinance</a> &raquo; <span class="breadcrumb_last">Consolidate Your Debt</span></span>
                </span>
                </span>
                </span>
            </nav>
                                ...
                                <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <h2><strong>Consolidate Your Debt and Lower Your Payments</strong></h2>
                                                <p>When refinancing your current mortgage, you might also want to consider consolidating other debt and lower your overall monthly payments at the same time. Mortgage rates compared to rates for other types of loans are the lowest of them all. Pay off those credit card balances and automobile loans while refinancing your mortgage. The result is lower overall monthly payments and better cash flow for you. It’s almost like giving yourself a raise!</p>
                                                <p>When mortgage rates are where they are now, regardless if you live in Boise City, Idaho or Pocatello or Twin Falls, paying off high interest date while refinancing your mortgage can make perfect financial sense. If you’re thinking of refinancing and you have other debt, you might want to consider consolidating all that debt into a low rate home loan.</p>
                                                <p>At NexGen Lending, a division of NexGen Lending, we have a variety of loan programs that can fit your needs from government-backed loan programs VA, FHA and USDA to conventional loan programs to jumbo loans, let’s take a closer look to see if a debt consolidation refinance can work to your advantage.</p>
                                                <p>Not sure which program is right for you? Contact one of our specialists today! NexGen Lending can advise you on which mortgage refinancing program best meets your needs, and help you refinance quickly and without any headaches.</p>
            ...
            <div id="sidebar-inner" class="clr">
                <div id="gform_widget-3" class="sidebar-box widget gform_widget clr">
                    ...
                    <div class='gf_browser_unknown gform_wrapper' id='gform_wrapper_2'>
                        ...
                        <form method='post' enctype='multipart/form-data' id='gform_2' action='/refinance/consolidate-your-debt/#gf_2'>
