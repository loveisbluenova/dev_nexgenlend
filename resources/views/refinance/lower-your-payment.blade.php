...
@section('top')
    <header class="page-header wpex-supports-mods">
        <div class="page-header-inner container clr">
            <h1 class="page-header-title wpex-clr" itemprop="headline"><span>Lower Your Payment</span></h1>
            <nav class="site-breadcrumbs wpex-clr hidden-phone position-absolute has-js-fix"><span class="breadcrumb-trail"><span><span><a href="/">Home</a> &raquo; <span><a href="/refinance">Refinance</a> &raquo; <span class="breadcrumb_last">Lower Your Payment</span></span>
                </span>
                </span>
                </span>
            </nav>
                                ...
                                <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <h2><strong>Lower Your Payment </strong></h2>
                                                <p>Mortgage rates have been holding relatively steady recently and for those who have been waiting to refinance their current rate to get a better one, now might be the best time to make the move. In today’s market, there are three primary types of mortgage loans, a fixed rate loan where the monthly payment never changes, a hybrid loan with an initial fixed period that switches after a few years into an adjustable rate mortgage and an adjustable rate mortgage that can change once every six or twelve months. And each of these three mortgage programs may very well provide an excellent opportunity to refinance your current loan and lower your monthly payment.</p>
                                                <p><strong>Fixed Rate Loans</strong></p>
                                                <p>For those planning on owning longer term then a fixed rate should be in the mix. The longer the loan term the lower the monthly payment and homeowners who recently financed their home with a 10, 15 or 20 year term can lower their monthly payment by refinancing into a 25 or 30 year loan.</p>
                                                <p><strong>FHA Loans</strong></p>
                                                <p>If you used an FHA loan to buy and finance your home you know the FHA program is one of the three government-backed mortgages. This backing is financed by two forms of mortgage insurance, an upfront policy rolled into the loan amount and an annual premium paid in monthly installments. Yet as property values have increased and homeowner equity is on the rise, refinancing out of an FHA loan and into a low conventional fixed rate can lower your overall monthly payment by getting rid of that monthly mortgage insurance payment.</p>
                                                <p><strong>VA Loans</strong></p>
                                                <p>If you have a VA loan now and are thinking of refinancing, the VA refinance process is probably the easiest of them all. If you’re going to lower your interest rate and refinance your existing VA loan into a new one, the amount of paperwork, cost and documentation is dramatically reduced. With a VA loan, you can refinance up to 100% of its current value.</p>
                                                <p><strong>Adjustable Rate Loans</strong></p>
                                                <p>For those with an adjustable rate mortgage, it’s time to consider switching out of an ARM and into the stability of a fixed rate mortgage. All indications are the Fed will continue to raise interest rates well into next year so refinancing now might be the best move you can make to permanently lower your monthly payment. And for those with a hybrid mortgage, the fixed portion of your loan will soon expire. You can avoid any surprises by refinancing out of your hybrid loan and into a low fixed rate.</p>
                                                <h2>Working with NexGen Lending</h2>
                                                <ul>
                                                    <li>We put YOU first.</li>
                                                </ul>
                                                <ul>
                                                    <li>NexGen Lending offers some of the most competitive rates in the Nation!</li>
                                                </ul>
                                                <ul>
            ...
            <div id="sidebar-inner" class="clr">
                <div id="gform_widget-3" class="sidebar-box widget gform_widget clr">
                    ...
                    <div class='gf_browser_unknown gform_wrapper' id='gform_wrapper_2'>
                        ...
                        <form method='post' enctype='multipart/form-data' id='gform_2' action='/refinance/lower-your-payment/#gf_2'>
