...
@section('top')
    <header class="page-header wpex-supports-mods">
        <div class="page-header-inner container clr">
            <h1 class="page-header-title wpex-clr" itemprop="headline"><span>Refinance</span></h1>
            <nav class="site-breadcrumbs wpex-clr hidden-phone position-absolute has-js-fix"><span class="breadcrumb-trail"><span><span><a href="/">Home</a> &raquo; <span class="breadcrumb_last">Refinance</span></span>
                </span>
                </span>
            </nav>
        </div>
                                    ...
                                    <div class="wpb_wrapper">
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                ...
                                                <p>Are you thinking of refinancing your existing mortgage? Maybe thinking of looking at a lower rate or paying off your mortgage sooner? Want to be mortgage-free when you retire? While refinancing to a lower rate is the most popular reason our clients refinance, there are other times when refinancing your home loan can be a wise decision. Let’s talk over the phone and let our NexGen Lending experienced loan offers look to see if refinancing makes sense for you.</p>
                                                <p><strong>When to Refinance</strong></p>
                                                <p>When is a good time to refinance? Well, if interest rates fall it can be a good idea. But don’t fall prey to the myth that you should only refinance if rates fall to a certain percent of what you currently have. There are other factors to consider such as getting out of an adjustable rate mortgage and into the stability of a fixed rate. Or, maybe you currently have a hybrid mortgage that’s going to adjust soon…if this is so, then it’s time to talk about refinancing now. Here are some other reasons:</p>
                                                <ul>
                                                    <li>Changing Loan Terms</li>
                                                    <li>Consolidating Debt</li>
                                                    <li>Cash Out For Any Reason</li>
                                                </ul>
                                                <p><strong>A Quick Call</strong></p>
                                                <p>Our experienced staff will review your situation, talk about your goals and see if a refinance is in your best interest. We can answer any question you have and provide you with everything you need to make refinancing your home mortgage a breeze!</p>
                                                ...
                                                <div id="stcpDiv" style="position: absolute; top: -1999px; left: -1988px;">
                                                    <h2>Working withNexGen Lending</h2>
                                                    <ul>
                                                        <li>YOU first. We are committed to getting every client the very best possible deal every single time</li>
                                                    </ul>
                                                    <ul>
                                                        <li>NexGen Lending offers some of the most competitive rates in the Nation!</li>
                                                    </ul>
            ...
            <div id="sidebar-inner" class="clr">
                <div id="gform_widget-3" class="sidebar-box widget gform_widget clr">
                    ...
                    <div class='gf_browser_unknown gform_wrapper' id='gform_wrapper_2'>
                        ...
                        <form method='post' enctype='multipart/form-data' id='gform_2' action='/refinance/#gf_2'>
