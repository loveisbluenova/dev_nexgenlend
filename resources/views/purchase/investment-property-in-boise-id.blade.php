...
{{-- Page title --}}
@section('title')
Mortgage rates for Investment Property in Boise ID
@parent
@stop
...
@section('top')
    <header class="page-header wpex-supports-mods">
        <div class="page-header-inner container clr">
            <h1 class="page-header-title wpex-clr" itemprop="headline"><span>Mortgage rates for Investment Property in Boise ID</span></h1>
            <nav class="site-breadcrumbs wpex-clr hidden-phone position-absolute has-js-fix"><span class="breadcrumb-trail"><span><span><a href="/">Home</a> &raquo; <span><a href="/purchase">Purchase Mortgage in Boise ID</a> &raquo; <span class="breadcrumb_last">Mortgage rates for Investment Property in Boise ID</span></span>
                </span>
                </span>
                </span>
            </nav>
                                ...
                                <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <h1>Mortgage rates for Investment Property in Boise ID</h1>
                                                <p>Boise, Idaho along with nearby communities of Lewiston, Twin Falls and Coeur d’Alene and others is one of the more popular spots in the entire country for vacation homes, second homes and investment real estate. At NexGen Lending, we provide financing rates for investment property in Boise ID that keeps more of your cash in your pockets and you don’t have to come to the closing table with 20 or 30 percent down. You can still finance with less money down while still getting some of the most competitive financing options around.</p>
                                                <p><strong>Fixed Rate Financing for an Investment Property in Boise ID</strong></p>
                                                <p>In today’s real estate market, interest rates are still extremely competitive. When financing your investment property in Boise ID, by locking in today’s fixed rates your payments will remain low throughout the life of the loan…your rate never changes.</p>
                                                <p><strong>Fixed Rate Terms</strong></p>
                                                <p>We offer a variety of loan terms to fit your budget and meet your long term goals. If paying as little interest as possible is your number one goal, let’s look at a 10 year term. Or, if the lowest monthly payment is part of your plan, then the 30 year might be the better choice. Maybe a little of both? We can also put together a 20 or 25 year term which saves on long term interest with a lower monthly payment compared to a 10 or 15 year term.</p>
                                                <p><strong>We’re the Experts</strong></p>
                                                <p>Don’t depend on some online lender that doesn’t know the Boise, Idaho area. We have working relationships with local professionals who will be at your side every step of the way.</p>
                                                <h2>Working with NexGen Lending for a loan on your Investment Property in Boise ID</h2>
                                                <ul>
            ...
            <div id="sidebar-inner" class="clr">
                <div id="gform_widget-3" class="sidebar-box widget gform_widget clr">
                    ...
                    <div class='gf_browser_unknown gform_wrapper' id='gform_wrapper_2'>
                        ...
                        <form method='post' enctype='multipart/form-data' id='gform_2' action='/purchase/investment-property-in-boise-id/#gf_2'>
