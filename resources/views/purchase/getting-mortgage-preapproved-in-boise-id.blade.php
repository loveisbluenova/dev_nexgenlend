...
@section('top')
    <header class="page-header wpex-supports-mods">
        <div class="page-header-inner container clr">
            <h1 class="page-header-title wpex-clr" itemprop="headline"><span>Getting Mortgage Preapproved in Boise ID</span></h1>
            <nav class="site-breadcrumbs wpex-clr hidden-phone position-absolute has-js-fix"><span class="breadcrumb-trail"><span><span><a href="/">Home</a> &raquo; <span><a href="/purchase">Purchase Mortgage in Boise ID</a> &raquo; <span class="breadcrumb_last">Getting Mortgage Preapproved in Boise ID</span></span>
                </span>
                </span>
                </span>
            </nav>
                                ...
                                <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <h1>Getting Mortgage Preapproved in Boise ID</h1>
                                                <p>We all know the real estate market in our area is extremely healthy right now. Home values are on the rise and the number of days on the market for listed homes is shrinking as more and more consumers compete for property. Whether it’s for a primary residence, a first home, a retirement home or an investment property, homes just don’t stay on the market for very long. That’s why you need to take advantage of getting mortgage preapproved in Boise ID.</p>
                                                <p><strong>Prequalification vs. Preapproval</strong></p>
                                                <p>These two terms sound familiar but they are in fact different. A prequalification is the result of a conversation with one of our loan officers over the phone or in person. Your NexGen Lending loan officer will ask various questions about your income and employment, how much you’d like to put down and a general sense of your credit history. Based upon this conversation, you can get an idea on how much you can qualify for.</p>
                                                <p>But with a preapproval, we take this process a bit further. A “prequal” is the result of a conversation while a preapproval is the result of verifying the information gathered from that conversation. A preapproval letter states that your income, credit and funds to close have been verified and essentially all that is needed is a property address. Real estate agents know the difference and when there are competing offers, the one with the preapproval letter will have the upper hand.</p>
                                                <h2>Why Should You Get Preapproved with NexGen Lending?</h2>
                                                <ul>
            ...
            <div id="sidebar-inner" class="clr">
                <div id="gform_widget-3" class="sidebar-box widget gform_widget clr">
                    ...
                    <div class='gf_browser_unknown gform_wrapper' id='gform_wrapper_2'>
                        ...
                        <form method='post' enctype='multipart/form-data' id='gform_2' action='/purchase/getting-mortgage-preapproved-in-boise-id/#gf_2'>
