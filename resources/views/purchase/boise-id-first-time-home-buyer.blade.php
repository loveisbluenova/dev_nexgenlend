...
{{-- Page title --}}
@section('title')
Boise ID First Time Home Buyer
@parent
@stop
...
@section('top')
    <header class="page-header wpex-supports-mods">
        <div class="page-header-inner container clr">
            <h1 class="page-header-title wpex-clr" itemprop="headline"><span>Boise ID First Time Home Buyer</span></h1>
            <nav class="site-breadcrumbs wpex-clr hidden-phone position-absolute has-js-fix"><span class="breadcrumb-trail"><span><span><a href="/">Home</a> &raquo; <span><a href="/purchase">Purchase Mortgage in Boise ID</a> &raquo; <span class="breadcrumb_last">Boise ID First Time Home Buyer</span></span>
                </span>
                </span>
                </span>
            </nav>
                                ...
                                <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <h1>Boise ID First Time Home Buyer programs and mortgage rates</h1>
                                                <p>We at NexGen Lending, understand how complex and sometimes even intimidating being a Boise ID first time home buyer. Yet our experienced loan officers will easily walk you through the entire process from prequalification to application all the way to the closing table. We have several Boise ID first time home buyer home loan options we can use to get you into your first time with payments you can afford. Curious about closing costs and down payment options? From Nampa to Meridian to Idaho Falls, let us show you how easy it is to buy and finance your first home. We can even help with down payment assistance programs that can get in your first home sooner rather than later!</p>
                                                <p><strong>Boise ID First Time Home Buyer Programs:</strong></p>
                                                <p>The <a href="../../fha-loan-boise-id/index.html">FHA loan program</a> is ideal for the first timer. Why? Because the down payment needed is just 3.5% of the sales price and offers relaxed qualifying guidelines as it relates to monthly payments and credit history.</p>
                                                <p><strong>30 Year Fixed Rate Terms</strong></p>
                                                <p>We offer fixed rate programs in terms ranging from 10 to 30 years but for first time home buyers wanting to bolster their buying power, the 30 year term offers the lowest monthly payment of all.</p>
                                                <p><strong>Down Payment Assistance</strong></p>
                                                <p>At NexGen, we have resources that can help with your down payment. One such program is the Chenoa Fund or the National Housing Fund, which provide down payment assistance for those needing a little extra help at the closing table.</p>
                                                <p><strong>We’re just a phone call away.</strong></p>
                                                <p>Want to know more? Then let’s talk! Our experienced staff is waiting to provide you with all the answers you need and see how much you can qualify for today!</p>
                                                <p>&nbsp;</p>
            ...
            <div id="sidebar-inner" class="clr">
                <div id="gform_widget-3" class="sidebar-box widget gform_widget clr">
                    ...
                    <div class='gf_browser_unknown gform_wrapper' id='gform_wrapper_2'>
                        ...
                        <form method='post' enctype='multipart/form-data' id='gform_2' action='/purchase/boise-id-first-time-home-buyer/#gf_2'>
