...
@section('top')
    <header class="page-header wpex-supports-mods">
        <div class="page-header-inner container clr">
            <h1 class="page-header-title wpex-clr" itemprop="headline"><span>fixed rate mortgage</span></h1>
            <nav class="site-breadcrumbs wpex-clr hidden-phone position-absolute has-js-fix"><span class="breadcrumb-trail"><span><span><a href="/">Home</a> &raquo; <span><a href="/loan-options">Loan Options</a> &raquo; <span class="breadcrumb_last">fixed rate mortgage</span></span>
                </span>
                </span>
                </span>
            </nav>
                                ...
                                <div class="vc_column-inner ">
                                    <div class="wpb_wrapper">
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <h1>Fixed Rates are Very Low!</h1>
                                                <p>If you plan to stay in your home for the long term, sleep tight knowing you will have the stability of a consistent payment that never changes. Plan your budget with a fixed rate mortgage at a low rate that will stay the same through the life of your loan.</p>
                                                <h2>How it Works</h2>
                                                <ul>
                                                    <li>Monthly payments based on interest rate, principal loan amount, and amortized interest with loan terms up to 30 years</li>
                                                </ul>
                                                <ul>
                                                    <li>Your payment will not change throughout the life of the loan</li>
                                                </ul>
                                                <ul>
                                                    <li>Your actual payment will vary based on your situation and the current interest rates when you apply</li>
                                                </ul>
                                                <ul>
                                                    <li>Pay your mortgage off at any time without pre-payment penalties</li>
                                                </ul>
                                                <h2>Qualification Requirements</h2>
                                                <ul>
                                                    <li>Refinance up to 95% of your primary home’s value</li>
                                                </ul>
                                                <ul>
                                                    <li>Buy a home with as little as 5% down (primary home)</li>
                                                </ul>
                                                <ul>
                                                    <li>Loan amounts from $25,000 to $2,000,000</li>
                                                </ul>
                                                <p>Got questions? Give us a call! One of our mortgage specialists would be happy to answer all of your questions and get you started with a great low rate today!</p>
            ...
            <div id="sidebar-inner" class="clr">
                <div id="gform_widget-3" class="sidebar-box widget gform_widget clr">
                    ...
                    <div class='gf_browser_unknown gform_wrapper' id='gform_wrapper_2'>
                        ...
                        <form method='post' enctype='multipart/form-data' id='gform_2' action='/loan-options/fixed-rate-mortgage/#gf_2'>
