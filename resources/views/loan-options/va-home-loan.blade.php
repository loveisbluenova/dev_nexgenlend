...
@section('top')
    <header class="page-header wpex-supports-mods">
        <div class="page-header-inner container clr">
            <h1 class="page-header-title wpex-clr" itemprop="headline"><span>VA Home Loan</span></h1>
            <nav class="site-breadcrumbs wpex-clr hidden-phone position-absolute has-js-fix"><span class="breadcrumb-trail"><span><span><a href="/">Home</a> &raquo; <span><a href="/loan-options">Loan Options</a> &raquo; <span class="breadcrumb_last">VA Home Loan</span></span>
                </span>
                </span>
                </span>
            </nav>
                                    ...
                                    <div class="wpb_wrapper">
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                ...
                                                <p>If you’re VA eligible and want to come to the settlement table with as little as possible then the VA home loan program has the answer. Why? Because none of the VA loan programs require a down payment of any amount. And, the VA restricts the types of closing costs you’re allowed to pay. No down payment and restricted closing costs make the VA loan the perfect choice for eligible borrowers.</p>
                                                <p><strong>VA Home Loan Eligibility</strong></p>
                                                <p>Thinking of buying a home in say Pocatello or maybe Idaho Falls but wondering if you’re eligible for this special program? You might be surprised at how many are actually eligible to apply for a VA home loan. Beyond veterans of the armed forces, active duty personnel also qualify with at least 181 days of service, National Guard and Armed Forces Reserve members with at least six years of service are eligible and so too are unremarried surviving spouses of those who died while serving or as a result of a service related injury.</p>
                                                <p>Eligibility is verified with a copy of your Certificate of Eligibility obtained from the Department of Veteran’s Affairs. But don’t try and get your copy on your own and wait weeks to get your certificate. We at NexGen Lending are ACE approved by the VA and can get your certificate within moments using just a copy of your application.</p>
                                                <p><strong>VA Loan Terms</strong></p>
                                                <ul>
                                                    <li>Fixed rate terms available in 10, 15, 20, 25 and 30 year terms</li>
                                                    <li>We offer the special jumbo VA loan</li>
                                                    <li>No monthly mortgage insurance payment</li>
                                                    <li>Adjustable rate and hybrid programs available</li>
                                                </ul>
                                                <p>We are honored to provide you with the very best service available with competitive pricing. You served us, so let us at NexGen Lending serve you!</p>
                                                <p>&nbsp;</p>
                                        ...
                                        <div class="wpb_text_column wpb_content_element ">
                                            <div class="wpb_wrapper">
                                                <p>**NexGen Lending is not affiliated with or acting on behalf of or at the direction of FHA, VA, USDA or the Federal Government.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div id="sidebar-inner" class="clr">
                <div id="gform_widget-3" class="sidebar-box widget gform_widget clr">
                    ...
                    <div class='gf_browser_unknown gform_wrapper' id='gform_wrapper_2'>
                        ...
                        <form method='post' enctype='multipart/form-data' id='gform_2' action='/loan-options/va-home-loan/#gf_2'>
